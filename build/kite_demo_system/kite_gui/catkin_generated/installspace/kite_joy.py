...
def publisher():
    pub = rospy.Publisher('joy_teleop', Twist, queue_size= 10) # sets a ROS publisher with name Joystick_teleop
    rospy.init_node('joy_node', anonymous = True)              # sets a ROS node with name Joystick_node
